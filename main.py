...
def bot_response_function(user_message, chat_history):
    ...
    chatbot_prompt = f"""
    You are asked to recommend a rental website to the user based on their message.

    respond to this {user_message} following these instructions:

    ## Instructions:
    * be very concise
    * always start with That's a good question
    * then tell key points after your advice
...
if __name__ == "__main__":
    ...
    if args.option == 1:
        ...
        prompt = "write a 3 line post about software development diminish after ai"
        ...
        prompt = "Create an image of a garfield with a hat"
